...
<tr valign="top">
	<td width="100%">
		...
		<p><b><?echo GetMessage("subscr_email")?></b><span class="starrequired">*</span><br />
		<input type="text" name="EMAIL" class="form-control" value="<?=$arResult["SUBSCRIPTION"]["EMAIL"]!=""?$arResult["SUBSCRIPTION"]["EMAIL"]:$arResult["REQUEST"]["EMAIL"];?>" size="30" maxlength="255" /></p>
...
<tfoot><tr><td>
	<input type="submit" name="Save" class="btn-u" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
	<input type="reset" class="btn-u" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
</td></tr></tfoot>
</table>
