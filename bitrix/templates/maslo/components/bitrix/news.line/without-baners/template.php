...
<? if ($arResult["ITEMS"]):?>
	<?
	//определяем мобильное устройство для баннера сгы
	function isMobile() {
								...
								<div class="illustration-v1 illustration-img<?=($keyIndex+1)?>">
									<div class="illustration-bg">
										<div class="illustration-ads ad-details-v1">
											...
											<? if (isMobile()) { ?>
												<? if ($arItem['PROPERTY_BUY_MOBILE_VALUE'] && $arItem['PROPERTY_LINK_MOBILE_VALUE']) { ?>
													<a class="btn-u btn-brd btn-brd-hover btn-u-light" href="<?=$arItem['PROPERTY_LINK_MOBILE_VALUE']?>"><?=$arItem['PROPERTY_BUY_MOBILE_VALUE']?></a>
												<? } elseif ($arItem['PROPERTY_BUY_TO_PAGE_VALUE'] && $arItem['PROPERTY_LINK_TO_PAGE_VALUE']) { ?>
