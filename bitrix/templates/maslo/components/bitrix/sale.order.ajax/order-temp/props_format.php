		...
		if (!empty($arSource))
		{
			?>	<!--<?php 
				...
				<div class="row margin-bottom-30">
                  <div class="col-sm-6">
					<input id="<?=$arSource[1]['FIELD_NAME']?>" type="text" placeholder="<?=$arSource[1]['~NAME']?><? if ($arSource[1]['REQUIED']=='Y'):?>*<?endif?>" value="<?=$arSource[1]['VALUE']?>" name="<?=$arSource[1]['FIELD_NAME']?>" class="form-control <? if ($arSource[1]['REQUIED']=='Y'):?>required<?endif?>">
                    <input id="<?=$arSource[8]['FIELD_NAME']?>" type="text" placeholder="<?=$arSource[8]['~NAME']?><? if ($arSource[8]['REQUIED']=='Y'):?>*<?endif?>" value="<?=$arSource[8]['VALUE']?>" name="<?=$arSource[8]['FIELD_NAME']?>" class="form-control <? if ($arSource[8]['REQUIED']=='Y'):?>required<?endif?>">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row">
                	<div class="col-sm-12">
                		<textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" class="form-control" style="max-width:100%;min-height:120px;"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
                    </div>
                </div>
