					...
					<tr id="<?=$arItem["ID"]?>">
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								<td class="custom width">
									...
									echo "<strong>".$arItem[$arHeader["id"]];
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
								?>
									<a class="delete" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><?/*=GetMessage("SALE_DELETE")*/?></a>
								<?
								endif;
								?>
							</td>
...
?>
	...
	<div style="display:block;">
		<div class="bx_ordercart_order_pay_left">
			...
			<a href="/personal/cart/?action=delete&id=all" class="btn btn-white">Очистить корзину</a>
		</div>
		<div class="bx_ordercart_order_pay_right">
			<a href="javascript:void(0)" onclick="checkOut();" class="btn btn-black"><?=GetMessage("SALE_ORDER")?></a>
		</div>
	</div>
</div>
<?
