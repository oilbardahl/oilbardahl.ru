...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	...
	<tr valign="top">
		<td width="100%">
			<p><?echo GetMessage("adm_auth1")?> <a href="/login/"><b><?echo GetMessage("adm_auth2")?></b></a>.</p>
				<?if($arResult["ALLOW_REGISTER"]=="Y"):?>
					<p><?echo GetMessage("adm_reg1")?> <a href="/login/register.php"><b><?echo GetMessage("adm_reg2")?></b></a>.</p>
				<?endif;?>
			<?echo GetMessage("adm_reg_text")?>
		</td>
	</tr>
	</table>
	<br />
<?elseif($arResult["ALLOW_ANONYMOUS"]=="N" || $_REQUEST["authorize"]=="YES" || $_REQUEST["register"]=="YES"):?>
	...
	<input type="submit" name="Save" value="<?echo GetMessage("adm_auth_butt")?>" class="btn-u" /></td></tr></tfoot>
	</table>
