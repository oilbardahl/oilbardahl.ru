<?
$MESS["IMAGINWEB_SMS_VOZMOJNOSTI"] = "";
...
$MESS["IMAGINWEB_SMS_UPRAVLENIE_SLUZOM_S_2"] = "Шлюз по умолчанию (сервис для отправки СМС и отключение)";
...
$MESS["IMAGINWEB_SMS_API_KEY"] = "API ключ:";
...
$MESS["IMAGINWEB_SMS_MGNOVENNOE_OPOVESENI"] = "мгновенное оповещение клиентов";
$MESS["IMAGINWEB_SMS_OTPRAVKA_SMS_PO_VSEM"] = "отправка смс по ВСЕМУ миру";
$MESS["IMAGINWEB_SMS_TOLQKO_PRAMYE_PODKLU"] = "только ПРЯМЫЕ подключения";
$MESS["IMAGINWEB_SMS_POZVOLAET_OTSLEJIVAT"] = "позволяет отслеживать ваши рассылки в";
$MESS["IMAGINWEB_SMS_REJIME_OBESPECIVAET"] = "режиме. Обеспечивает круглосуточную поддержку. Дополнительные возможности сервиса";
$MESS["IMAGINWEB_SMS_RASSYLKA_GOLOSOVYE"] = "рассылка, голосовые сообщения, мобильная интернет-реклама.";
$MESS["IMAGINWEB_SMS_ZA_PODROBNOY_INFORMA"] = "За подробной информацией обращайтесь";
$MESS["IMAGINWEB_SMS_PROMO_QTELECOM"] = "<a href=\"http://www.qtelecom.ru\" target=\"_blank\">http://www.qtelecom.ru</a>
<br/>Платформа QUICKTEL® для SMS сервисов:
<br/>- модули SMS подписки<br/>- модули SMS рассылки<br/>- рассылка SMS на всех операторов России и Мира
<br/>- интеграция с вашим по любым протоколам<br/>- мобильные приложения<br/>- SMS реклама по базам операторов и терминалов оплаты
<br/>- дополнительные сервисы: HLR, USSD, Wap Push<br/>- оптимальное соотношение цены и высокого качества сервиса";
$MESS["IMAGINWEB_SMS_OBRABATYVATQ_SOOBSEN"] = "Обрабатывать сообщения как";
$MESS["IMAGINWEB_SMS_KOD"] = "код";
$MESS["IMAGINWEB_SMS_NET"] = "Нет";
$MESS["IMAGINWEB_SMS_DA_VSE_SOOBSENIA_BU"] = "Да (ТОЛЬКО ДЛЯ РАЗРАБОТЧИКОВ PHP!!!)";
$MESS["IMAGINWEB_SMS_KOD_PERED_OTPRAVKOY"] = "";
$MESS["IMAGINWEB_SMS_RABOTAEM_PO_VSEM_STR"] = "Работаем по всем странам, легкая интеграция, отправка смс от своего имени отправителя";
$MESS["IMAGINWEB_SMS_RABOTAEM_PO_VSEM_STR1"] = "Работаем по всем странам, легкая интеграция, отправка смс от своего имени отправителя.";
$MESS["IMAGINWEB_SMS_ETO_SERVIS_SMS_RAS"] = "– это сервис смс рассылок, позволяющий отправлять сообщение в любую точку мира через веб-интерфейс. Это отличный способ повышение лояльности своих клиентов, поздравляя их с праздниками, а также информируя о ваших акциях и поступлениях. С помощью нас и";
$MESS["IMAGINWEB_SMS_VY_SMOJETE_INTEGRIRO"] = "вы сможете интегрировать свой сайт к нашей системе для отправок смс-уведомлений. Зарегистрируйтесь и получите 5 тестовых рублей для проверки работоспособности нашей системы. Далее, на нашем сайте вы сможете приобрести различные пакеты по индивидуальной стоимости";
$MESS["IMAGINWEB_SMS_PROMO_DEVINOTELECOM"] = "<a href=\"http://devinotele.com/\" target=\"_blank\">DevinoTelecom</a> – 10 лет на рынке телеком услуг, лидер в ритейле среди поставщиков SMS информирования ( по данным ACM Consulting 2015)
<br />- Качество и надежность<br />- Гарантированная доставка<br />- Дружелюбный интерфейс<br />- Интеграции со всеми платформами
<br />- SMS информирование<br />- SMS подписки<br />- Прием SMS на короткие и федеральные номера<br />- EMAIL маркетинг
<br />- CRM Консалтинг<br />- Техподдержка и Юридическая служба<br />- Собственная платформа";
$MESS["IMAGINWEB_SMS_PROMO_INSTAM"] = "<a href=\"http://instam.ru/\" target=\"_blank\">ГК ИНСТАМ</a> – ведущий игрок в российском сегменте мобильного маркетинга. Более 10 лет мы осваиваем новые технологии и растем вместе с рынком.
<br />Наши преимущества:<br />Техническая поддержка 24/7;<br />Рассылка по всему миру;<br />Высокая скорость и стабильность;
<br />Мгновенная доставка;<br />Оптимальные цены;<br />Гарантированная безопасность;<br />Простая интеграция;<br />Уникальный личный кабинет.";
$MESS["IMAGINWEB_PROCESSING_EVENTS_D7"] = "Включить обработку событий ядра D7";
?>