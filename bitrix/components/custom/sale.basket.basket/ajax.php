...
if (isset($_POST[$action_var]) && strlen($_POST[$action_var]) > 0)
{
	...
	else if ($_POST[$action_var] == "recalculate")
	{
		...
		CBitrixComponent::includeComponentClass("custom:sale.basket.basket");
...
function ResponseList($callBack, $type , $articles = array()) {
...
die(ResponseList($calcback, "update_element_catalog_store" , array()));
